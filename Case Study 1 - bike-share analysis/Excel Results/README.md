...
 <ol>
   ...
   ### Extra credit: Some months *might* have faulty "ride_length" data. As analyst doing our process step lets investigate using "Sort", notice how a small % of cells are wildly out of range of the majority, great job! 🙌 There might be cells filled with ###### forever, keep this in mind when loading into SQL later.
