...
*Google Sheets won't open files of these sizes. Excel is your only option to open the data. The instructions for Google Sheets are unfortunately pointless:frowning:.*
