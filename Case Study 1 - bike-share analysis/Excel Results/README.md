...
<summary> Cleaning the data </summary>
  ...
  *This process is per situation, and normally stakeholders are involved with the decision on what to do with empty cells.*
  ...
  <ol>
    ...
    <li> Sadly, you must do all of these steps on all sheets as many times as it takes (usually 2) until your results land you at the bottom of the sheet. The benefit of checking one too many times is you get the last row number. This helps if you search for the bottom.</li>
  </ol>
  <ul>
...
 <ol>
   ...
   ### Some months *might* have faulty "ride_length" data. As analyst doing our process step lets investigate using "Sort", plus it's good practice 🙌
