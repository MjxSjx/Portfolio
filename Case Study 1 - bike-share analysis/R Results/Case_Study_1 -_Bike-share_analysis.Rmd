...
<strong>Our specifically assigned task is only to answer question number one. <em>"How do annual members and casual riders use Cyclistic bikes differently?"</em> The rest are handled by other team members </strong>
...
We will use Cyclistic’s historical trip data to analyze and identify trends. Our analysis will be based on the last annual cycle, from April 2022 to May 2023. The data has been made available by Motivate International Inc. under this [License](https://ride.divvybikes.com/data-license-agreement).
...
Casual users ride 33% longer distances on average compared to members, potentially indicating a preference for longer rides or exploring different destinations. July records the highest ridership, while December has the lowest, possibly due to weather conditions and holiday-related factors. Saturday is the most popular day of the week across all users and the only day casual users slightly surpass members in usage.

<strong> 5. Supporting visualizations and key findings </strong>

All Excel, SQL, and R-supporting visualizations are found in the [GitHub Portfolio repository "Case Study 1: bike-share analysis"](https://github.com/MjxSjx/Portfolio/tree/main/Case%20Study%201%20-%20bike-share%20analysis) in extensive detail, and Tableau at [Case Study 1: Bike-share analysis](https://public.tableau.com)

<strong> 6. Your top three recommendations based on your analysis </strong>

<ol>
  1. Focus on targeted marketing in locations where casual users are most predominate, increasing marketing results while decreasing expenditure.
  
  2. Increase awareness of membership benefits in highest use locations for casual users.
  3. Create incentives to convert causal riders to make the switch. 
  
  4. Create a survey for all users to answer to gain more insight.
</ol>


## Solution:

In truth the solution is beyond our assigned task. Any implications are nothing more than speculation without answers from the other two questions. However, what our question can tell you is facts about the difference between annual members and causal riders. With that said, from May 2022 - April 2023:

* Members ride 34.7% more often than casual users
* Members average annual ride duration was 12 minutes and 14 seconds 
* Members most often ride on Wednesday and weekdays in general
* Members most often ride between 3-6pm, casuals are the same 3-6pm
* Members top start & end station is located at: Kingsbury & Kinzie St
* Members prefer our classic bikes at a rate of 63.8% of all their rentals. A distant second is our electric bike at 36.2%
* Casual users top start & end station is located at: Streeter Dr & Grand Ave
* Casual users most often ride on Saturday and weekends in general
* Casual users ride 33% longer than members
* Casual users average annual ride duration was 23 minutes and 2 seconds
* Casual users prefer the weekends; while members prefer the weekdays
* Casual users prefer our classic bikes at a rate of 49.6% of all their rentals. A close second is our electric bikes at 41%
* Both members and casual riders use our classic bike as their top rental 
* Both members and casual riders prefer months between April to October 
* July was our most popular month, with December being the least popular
* Annually Saturday was the most popular day of the week, with casual users just barely surpassing members in usage
...
### R Results
Present in this Rmd file at the bottom on the page
...
In conclusion, the analysis of the provided data gave us several key insights. Members ride more frequently than casual users, showing a clear preference for weekdays which peak on Wednesdays. They also tend to ride during the late afternoon hours, indicating a commuting pattern. The top start and end station for members is Kingsbury & Kinzie St, suggest a concentrated area of member activity that gives us an opportunity to create targeted surveys to gain valuable insights specifically about what makes our services worth the annual membership.

Casual users exhibit different preferences. They ride less frequently but for longer distances, with a preference for weekends which peak on Saturdays. Their top start and end station is located at Streeter Dr & Grand Ave, indicating a different area of interest compared to members. Allowing for targeted advertising to casual riders. 

All of these findings highlight the importance of understanding the distinct behaviors and preferences of members and casual users. By discovering this information, Cyclistic can tailor our strategies to better serve these different user types. Cyclistic can Optimize station placements, adjust operational schedules to accommodate peak times, and design targeted marketing campaigns to attract and retain both member and casual riders. All of this can enhance the overall user experience and lead to greater customer satisfaction, while bringing Cyclistic sustain growth. The data-driven approach used in this analysis demonstrates the power of leveraging information to make informed decisions and drive the success of Cyclistic.


## Next steps:

We should collaborate with the rest of the team and find out what insights they gathered from the assignment Lily Moreno assigned them to. We should, consider gaining additional data from things like surveys and utilize targeted advertising to casual rider dense locations that preferably include: 

Preferred payment options: Investigate whether annual members and casual riders have preferences for specific payment options, such as credit card, mobile apps, or in-person payments.
...
Casual user-Specific Marketing: Develop targeted marketing campaigns for members and casual users separately. Highlight the convenience, cost-effectiveness, and environmental benefits of membership for attracting and retaining members. For casual users, emphasize the flexibility, leisurely experience, and weekday  promotions to encourage weekend ridership.


4. Seasonal Promotions: Capitalize on the popularity of July by introducing special promotions, such as discounted membership rates, extended riding hours, or partnerships with local events and attractions. Additionally, for December, consider offering holiday-themed incentives, such as festive decorations, seasonal rides, or charity initiatives to engage riders and increase usage.

5. Data-Driven Decision Making: Continuously monitor and analyze rider data to identify emerging trends, patterns, and areas of improvement. This will enable the bike-sharing program to make informed decisions and adapt strategies to evolving user needs.

By implementing these recommendations, the bike-sharing program can foster a more personalized and enjoyable experience for both members and casual users. This tailored approach will not only attract new riders but also increase rider loyalty and engagement, leading to sustainable growth and a competitive edge in the market.


The proposed solutions gained by data analysis aim to enhance marketing efficiency, by utilizing targeted strategies in advertising and surveys to each respective user type. Cylistic can position itself for sustained growth while fostering a positive impact on the community and promoting sustainable transportation.
