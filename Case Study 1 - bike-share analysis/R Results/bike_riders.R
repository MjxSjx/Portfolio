...
# The purpose of this script is to consolidate downloaded Divvy data 
...
all_trips$date <- as.POSIXct(all_trips$started_at, format = "%Y-%m-%d %H:%M:%S")
...
XXXXXXXXXXXXX is.factor(all_trips$ride_length)
