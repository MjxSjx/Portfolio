...
### Make sure you create a directory for your RStudio project
  * The far top-right has a tab just below the applications "Close tab" click it > New Project > name your directory and its location > Create Project.
