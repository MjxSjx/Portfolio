...
* [The course](https://cs50.harvard.edu/x/2023/) 🏫
   ...
   <li> <strong>Reminder:/<strong> You may get a "ride_length" error claiming endless ################## are stored instead of valid data. Refer to [Adding ride_length](https://github.com/MjxSjx/Portfolio/tree/main/Case%20Study%201%20-%20bike-share%20analysis/Excel%20Results)  Excel walkthrough on how to fix it.
