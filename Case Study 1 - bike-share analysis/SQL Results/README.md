...
<ol>
 ...
 <ul>
    <li><strong>datetime:</strong> This will auto-populate by SQL when data exceeds 25-39 hours.</li>
  <li><strong>nvarchar(50):</strong> This will auto-populate when durations are over 40 hours and what you <strong>must</strong> change all 12 to 👍. </li>
