...
<ol>
 ...
 <ul>
  <li><strong>nvarchar(50):</strong> This will auto-populate when durations are over 100 hours and what you <strong>must</strong> change all 12 to 👍. </li>
  <li><strong>datetime:</strong> This will auto-populate by SQL when data just exceeds 24 hours.</li>
  <li><strong>time:</strong> This will auto-populate by SQL when the data <strong>does not</strong> exceed 24 hours.</li>
